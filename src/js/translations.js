...
const translations = {
    RU: {
        ...
        'roadmap-in-progress': 'В разработке 🛠️',
        ...
        'network-garmin-desc': 'Подключите свой аккаунт, и отслеживайте активность',
        'network-slack-title': 'Slack-уведомления',
        'network-slack-desc': 'Получайте уведомления в своем рабочем пространстве Slack',
        ...
        'tsygram-title': 'Tsygram',
        'tsygram-desc': 'Мессенджер для команд и спортсменов',
        'create-website-title': 'Создание сайтов',
        'create-website-desc': 'Создавайте сайты для ваших проектов',
        ...
        'menu': 'Меню',
         ...
         // Модальное окно смены языка
        'language-suggestion-text': 'Change the language',
        
        // AI page
        'ai-page-title': 'T‑Sync | ИИ‑ассистент',
    ...
    EN: {
        ...
        'help-card-getting-started-title': 'Getting started',
        'help-card-getting-started-desc': 'Create an account, set up your profile, and learn platform basics',
        'help-card-rooms-title': 'Rooms and workouts',
        'help-card-rooms-desc': 'Create workouts, manage teams, and track progress',
        'help-card-settings-title': 'Settings',
        'help-card-settings-desc': 'Personalize the interface and manage your account',
        'help-nav-1': '#1. Getting started',
        'help-nav-1-intro': '📍 Introduction',
        'help-nav-1-steps': '👣 First steps',
        'help-nav-2': '#2. Workspace',
        'help-nav-2-intro': '📍 Introduction',
        'help-nav-2-navigation': '🔎 Navigation',
        'help-nav-2-zones': '📁 Create and delete a zone',
        'help-nav-3': '#3. Rooms and workouts',
        'help-nav-3-intro': '📍 Introduction',
        'help-nav-3-all': '🧩 All about rooms and workouts',
        'help-nav-3-actions': '✏️ Actions',
        'help-nav-4': '#4. Collaboration',
        'help-nav-4-intro': '📍 Introduction',
        'help-nav-4-permissions': '📣 Sharing and permissions',
        'help-nav-4-members': '🔨 Member management',
        'help-nav-4-collab': '💼 Collaboration',
        'help-nav-5': '#5. AI assistant',
        'help-nav-5-what': '🤖 What is T‑Sync AI?',
        'help-nav-5-notes': '🪄 Notes with AI (beta)',
        'help-nav-5-answers': '🎙️ Additional T‑Sync AI answers',
        'help-nav-5-security': '🎟️ T‑Sync AI security and privacy practices',
        'help-nav-6': '#6. Data and integrations',
        'help-nav-6-import': '🚚 Data import and export',
        'help-nav-6-backup': '💿 Data backups',
        'help-nav-7': '#7. Plans and billing',
        'help-nav-7-change-plan': '💸 Change an existing plan',
        'help-nav-8': '#8. Security and privacy',
        'help-nav-8-practices': '🔒 Security best practices',
        'help-nav-8-privacy': '🗝️ Privacy policy',
        'help-nav-8-owner-data': '🚨 Data available to your workspace owner',
        'help-nav-8-report': '☎️ Report unacceptable content',
        'help-nav-8-shared': '🛡️ Shared responsibility model',
        'help-nav-8-hosting': '🗃️ T‑Sync data hosting',
        'help-nav-9': '#9. Settings',
        'help-nav-9-account': '⚙️ Account settings and preferences',
        'help-nav-9-notifications': '🛎 Notification settings',
        'help-nav-9-workspace': '🗝️ Workspace settings',
        'help-nav-9-ip': '🌐 IP addresses and domains',
        'help-nav-9-hipaa': '🏥 HIPAA configuration',
        'help-nav-9-consent': '🚪 Data access consent',
        'help-nav-9-delete': '🗑 Delete your account',
        'help-nav-9-auth': '🔐 Sign in and out',
        'help-nav-10': '#10. Troubleshooting',
        'help-nav-10-reset': 'Reset concepts',
        'help-nav-10-access': "I can't access my account",
        'help-nav-10-view': "I can't load or view a file",
        'help-nav-10-errors': 'General concept errors',
        'help-sec-1-title': '#1. Getting started',
        'help-sec-1-card1-title': 'Start here',
        'help-sec-1-card1-desc': 'Overview of T‑Sync capabilities and first login.',
        'help-sec-1-card2-title': 'Create a page',
        'help-sec-1-card2-desc': 'How to create your first page and folder structure.',
        'help-sec-2-title': '2. Workspace',
        'help-sec-2-card1-title': 'Navigation',
        'help-sec-2-card1-desc': 'Quick search and moving across sections.',
        'help-sec-2-card2-title': 'Teams and roles',
        'help-sec-2-card2-desc': 'Access rights and member management.',
        'help-sec-3-title': '3. Pages and blocks',
        'help-sec-3-card1-title': 'Editing',
        'help-sec-3-card1-desc': 'Text formatting, lists, media.',
        'help-sec-3-card2-title': 'Templates',
        'help-sec-3-card2-desc': 'Use ready-made presets to start quickly.',
        'help-sec-4-title': '5. Collaboration',
        'help-sec-4-card1-title': 'Rights and access',
        'help-sec-4-card1-desc': 'Sharing, invites, and comments.',
        'help-sec-4-card2-title': 'Notifications',
        'help-sec-4-card2-desc': 'Subscriptions, mentions, and reminders.',
        'help-sec-5-title': '6. Data and integrations',
        'help-sec-5-card1-title': 'Integrations',
        'help-sec-5-card1-desc': 'Connect Garmin, Strava, and more.',
        'help-sec-5-card2-title': 'Export and backups',
        'help-sec-5-card2-desc': 'Data export and recovery.',
        'help-sec-6-title': '7. Automations',
        'help-sec-6-card1-title': 'Rules and buttons',
        'help-sec-6-card1-desc': 'Configure scenarios and quick actions.',
        'help-sec-6-card2-title': 'Notifications and webhooks',
        'help-sec-6-card2-desc': 'Integrate events with external systems.',
        'help-sec-7-title': '8. Plans and billing',
        'help-sec-7-card1-title': 'Tariffs',
        'help-sec-7-card1-desc': 'Plan selection and features per tier.',
        'help-sec-7-card2-title': 'Invoices and payments',
        'help-sec-7-card2-desc': 'Payment history, receipts, and refunds.',
        'help-sec-8-title': '9. Security and privacy',
        'help-sec-8-card1-title': 'Security',
        'help-sec-8-card1-desc': '2FA, password policy, and access control.',
        'help-sec-8-card2-title': 'Privacy',
        'help-sec-8-card2-desc': 'Data storage and personal data processing.',
        'help-sec-9-title': '10. Troubleshooting',
        'help-sec-9-card1-title': 'Cannot sign in',
        'help-sec-9-card1-desc': 'Common causes and quick fixes.',
        'help-sec-9-card2-title': 'Data load error',
        'help-sec-9-card2-desc': 'How to diagnose and what to do next.',

        // Create Website
        'cw-hero-title': 'Create a personal website in minutes with <span class="highlight-word">T‑Sync Creatium</span>',
        'cw-create-site': 'Create website',
        'cw-view-templates': 'View templates',
        'cw-quick-start-title': 'Quick start',
        'cw-quick-start-desc': 'The simplest way to launch your website.',
        'cw-fill-data': 'Fill in details',
        ...
        'cw-card-contacts-desc': 'Let others get in touch with you',
        'cw-templates-title': 'Site templates',
        'cw-templates-soon-title': 'Templates coming soon',
        'cw-templates-soon-desc': 'We are working on beautiful, functional templates for your sites.',

        // Privacy
        'privacy-page-title': 'Privacy Policy – T‑Sync',
        'privacy-breadcrumb-title': 'Privacy Policy',
        'privacy-title': '🔒 T‑Sync Privacy Policy',
        'privacy-last-updated-label': 'Last updated:',
        'privacy-link-1': '1. General provisions',
        'privacy-link-2': '2. Data collected',
        'privacy-link-3': '3. Use of data',
        'privacy-link-4': '4. Data sharing',
        'privacy-link-5': '5. Data protection',
        'privacy-link-6': '6. Cookies',
        'privacy-link-7': '7. User rights',
        'privacy-link-8': '8. Changes to Privacy Policy',
        'privacy-contacts-title': 'Contact information',
        'privacy-sec1-title': '1. General provisions',
        'privacy-sec1-p1': '1.1. This Privacy Policy governs the collection, storage, use, and protection of personal data of users of the <strong>T‑Sync</strong> platform.',
        'privacy-sec1-p2': '1.2. The platform is intended for coaches and athletes collaborating in a <strong>B2B</strong> format (managing training, planning workload, monitoring progress).',
        'privacy-sec1-p3': '1.3. By using the Platform, you agree to this Policy.',
        'privacy-sec2-title': '2. What data do we collect?',
        'privacy-sec2-intro': 'We collect information when you provide it to us, when you use the program or services, and when it is provided to us by other sources, as described below.',
        'privacy-sec2-2-1-title': '2.1. Information you provide to us:',
        'privacy-sec2-2-1-li1': '<strong>Account creation:</strong> When you create an account or otherwise use the Services, we collect information such as your name, email address, password, your role within your team or organization, and an optional profile photo.',
        'privacy-sec2-2-1-li2': '<strong>Your communications with us:</strong> We collect information such as email address, phone number, or mailing address when you request information about our services, sign up for newsletters, request customer or technical support, or otherwise contact us. We also collect message content or attachments you may send to us, as well as other information you choose to provide, which may be associated with your communications.',
        'privacy-sec2-2-1-li3': '<strong>Payment information:</strong> When you purchase a subscription to the Services, you will need to provide payment information (e.g., financial account data, shipping information) to complete your subscription. We use third‑party payment providers to process payments for the Services. We may receive information related to your payment information such as billing address and transaction information, but we do not store payment information directly within the Services. Payment information is stored and processed by our payment providers on our behalf.',
        'privacy-sec2-2-1-li4': '<strong>Surveys:</strong> We may contact you to participate in surveys. If you choose to participate, you may be asked to provide certain information, which may include contact information and other information about you.',
        'privacy-sec2-2-1-li5': '<strong>Interactive features:</strong> We may offer interactive features such as forums, blogs, chat and messaging services, and social media pages. We and others who use our website or Services may collect the information you submit or make available through these interactive features. Any content you provide through public areas of these features will be considered “public” and is not subject to the privacy protections referenced herein. By using these interactive features, you understand that the information you provide may be viewed and used by third parties for their own purposes.',
        'privacy-sec2-2-2-title': '2.2. Automatically collected data:',
        'privacy-sec2-2-2-li1': '<strong>Automatic data collection:</strong> We track certain information about you when you visit and interact with the site. This information may include your IP address, user settings, MAC address, cookie identifiers, mobile carrier, mobile advertising and other unique identifiers, information about your browser, operating system or device, location information (including generalized location derived from your IP address), Internet service provider, pages you visit before, during and after using the Website or Services, link information you click, information about how you interact with the Website or Services, including the frequency and duration of your activities, and other information about how you use the Website or Services. The information we collect may be associated with accounts and other devices.',
        'privacy-sec2-2-2-li2': '<strong>Cookies:</strong> We and third parties that provide content, advertising, or other functionality within the Services may use cookies, pixel tags, local storage, and other technologies ("Technologies") to automatically collect information through the Website or services. Technologies are essentially small data files placed on your devices that allow us and our partners to record certain pieces of information whenever you visit or interact with our Services.',
        'privacy-sec2-2-2-li3': '<strong>Analytics:</strong> We may also use third‑party service providers to collect and process analytics data and other information on our website or in the Services. These third‑party service providers may use technologies to collect and store analytics data and other information. They have their own privacy policies regarding how they use analytics and other information, and we do not have access to or control over third parties’ use of cookies or other tracking technologies.',
        'privacy-sec3-title': '3. How do we use data?',
        'privacy-sec3-intro': 'We use your information for a variety of business purposes, including:',
        'privacy-sec3-li1': '<strong>Profile creation and management:</strong> Personal data is used to create personalized user profiles, provide access to the platform, and personalize the interface.',
        'privacy-sec3-li2': '<strong>Workspace management:</strong> If you register a T‑Sync account or link an account with an email address provided by your organization, we may share with your organization information about you and any workspaces you own or manage. Such information may include your name, email address and profile photo, as well as workspace name, workspace ID, membership size, the date your workspace was created, and your organization’s email address and workspace content.',
        'privacy-sec3-li3': '<strong>Training effectiveness analysis:</strong> The system automatically processes exercise performance statistics to assess progress and adjust workloads.',
        'privacy-sec4-title': '4. Who do we share data with?',
        'privacy-sec4-p1': '4.1. <strong>Coach ↔ Athlete</strong> – data is available within their interaction on the Platform.',
        'privacy-sec4-p2': '4.2. <strong>Technical contractors</strong> – only to ensure service operation (hosting, analytics).',
        'privacy-sec4-p3': '4.3. <strong>Government authorities</strong> – only upon lawful request.',
        'privacy-sec5-title': '5. Data protection',
        'privacy-sec5-p1': '5.1. We use:<br>— Encryption (SSL/TLS)<br>— Regular security audits<br>— Limited data access',
        'privacy-sec5-p2': '5.2. Users must:<br>— Not share logins/passwords with third parties<br>— Use strong passwords',
        'privacy-sec6-title': '6. Cookies and similar technologies',
        'privacy-sec6-intro': '6.1. The platform uses cookies for:',
        'privacy-sec6-li1': 'Authorization',
        'privacy-sec6-li2': 'Traffic analytics',
        'privacy-sec6-note': '6.2. You can disable cookies in your browser settings, but this will affect functionality.',
        'privacy-sec7-title': '7. User rights',
        'privacy-sec7-intro': 'You can:',
        'privacy-sec7-li1': 'Request access to your data',
        'privacy-sec7-li2': 'Correct inaccuracies',
        'privacy-sec7-li3': 'Delete your account (data will be anonymized)',
        'privacy-sec7-li4': 'Withdraw consent to processing',
        'privacy-sec8-title': '8. Changes to Privacy Policy',
        'privacy-sec8-p1': 'We may revise this Privacy Policy from time to time at our sole discretion. If any material changes are made to this Privacy Policy, we will notify you in accordance with applicable law. You understand and agree that you will be deemed to have accepted the updated Privacy Policy if you continue to use the Services after the new Privacy Policy becomes effective.',
        'privacy-contacts-site': '🌐 Website: <a href="http://t-sync.ru" target="_blank" rel="noopener noreferrer">t-sync.ru</a>',
        'privacy-contacts-phone': '📱 Phone: <a href="tel:+79646150520">+7 964 615 05 20</a>',
        'privacy-contacts-inn': 'TIN 672908781554',

        // Roadmap statuses
        'status-completed': 'Completed',
        'status-in-development': 'In development',
        'status-planned': 'Planned',
        'status-discussed': 'Under discussion',
        ...
        // Roadmap common
        'roadmap-page-title': 'Roadmap – T‑Sync',
        'roadmap-breadcrumb-title': 'Roadmap',
        'roadmap-title': 'Roadmap',
        'roadmap-intro': 'Our plans and progress on new features.',
        'roadmap-suggestions-title': 'Got suggestions?',
        'roadmap-suggestions-desc': 'Your ideas help make our service better 🙌',
        'roadmap-suggestions-cta': 'Submit an idea',

        // Roadmap items
        'roadmap-analytics-view-title': 'Analytics and training reports',
        'roadmap-analytics-view-desc': 'Ability to view training analytics.',
        'roadmap-analytics-view-full': 'A full-fledged analytics system with detailed reports, progress charts, and statistics. Includes load analysis, recovery, training efficiency, and personal recommendations.',

        'roadmap-drag-windows-title': 'Drag windows added',
        'roadmap-drag-windows-desc': 'You can drag modal windows to optimize your workflow in the platform.',
        'roadmap-drag-windows-full': 'Innovative drag-and-drop system for modals, allowing users to tailor the interface to their needs. Improves usability and productivity.',

        'roadmap-add-members-title': 'Add members',
        'roadmap-add-members-desc': 'Invite other users to your workspace.',
        'roadmap-add-members-full': 'Team management with invitations, role assignments, and access control. Ideal for coaches and sports teams.',

        'roadmap-platform-created-title': 'Platform created',
        'roadmap-platform-created-desc': 'Fully working platform functionality.',
        'roadmap-platform-created-full': 'The T-Sync core platform with a complete set of training management features including planning, progress tracking, and analytics.',

        'roadmap-platform-design-title': 'Platform design',
        'roadmap-platform-design-desc': 'Final platform design established. Next step — feature development.',
        'roadmap-platform-design-full': 'Modern, intuitive design following UX/UI best practices. Responsive interface for all devices.',

        'roadmap-resource-website-title': 'Resource website',
        'roadmap-resource-website-desc': 'Information website with the latest news and updates.',
        'roadmap-resource-website-full': 'An information portal with up-to-date news, documentation, and resources for T-Sync users. Regular updates and support.',

        'roadmap-garmin-integration-title': 'Garmin Connect integration',
        'roadmap-garmin-integration-desc': 'Connect a Garmin account and sync workouts.',
        'roadmap-garmin-integration-full': 'Direct integration with Garmin Connect for automatic synchronization of workouts, heart rate, GPS tracks, and other metrics from Garmin devices.',

        'roadmap-website-templates-title': 'Website template selection',
        'roadmap-website-templates-desc': 'Choose a template for your website.',
        'roadmap-website-templates-full': 'A library of professional templates for creating personal sites. Various styles and themes for different sports and preferences.',

        'roadmap-creatium-service-title': 'T-Sync Creatium service',
        'roadmap-creatium-service-desc': 'Create personal websites about yourself.',
        'roadmap-creatium-service-full': "A service for creating personal sports websites with design customization, content, and social integrations. <a class='roadmap-window-link' href='/products/create-website/'>Visit page</a>",

        'roadmap-tsygram-service-title': 'Tsygram service',
        'roadmap-tsygram-service-desc': 'A social network for athletes and coaches.',
        'roadmap-tsygram-service-full': 'A social platform for athletes, coaches, and enthusiasts. Share experience, find like-minded people, and build a sports community.',

        'roadmap-ai-assistant-title': 'AI assistant',
        'roadmap-ai-assistant-desc': 'Developing an AI assistant for personalization and automation of your training.',
        'roadmap-ai-assistant-full': 'Artificial intelligence for personalized training, data analysis, and automatic creation of training programs based on goals and abilities.',

        'roadmap-conferences-title': 'Conferences within the platform',
        'roadmap-conferences-desc': 'Developing an AI assistant for personalization and automation of your training.',
        'roadmap-conferences-full': 'Built-in system for online conferences, webinars, and master classes. Ideal for coaches and sports organizations.',

        'roadmap-trainers-board-title': 'Coaches board',
        'roadmap-trainers-board-desc': 'Upload your profile and attract new athletes to the Workspace.',
        'roadmap-trainers-board-full': 'A platform for coaches with profiles, achievements, and client acquisition. Reviews and rating system.',
        ...
        'roadmap-suggestions-cta': 'Submit an idea',
        'roadmap-done': 'Done 🎉',
        'roadmap-in-progress': 'In progress 🛠️',
        ...
        'error-404-description': 'Unfortunately, the requested page does not exist or has been moved. You may have followed an incorrect link or entered the wrong address.',
        'error-404-button': 'Back to Home',
        
        // Navigation dropdown
        'nav-platform-title': 'T-Sync Platform',
        'nav-platform-desc': 'Training Management Platform',
        'nav-creatium-title': 'T-Sync Creatium',
        'nav-creatium-desc': 'Personal Website Creation',
        'nav-tsygram-title': 'Tsygram',
        ...
        // Hero section
        'launch-date': 'Platform launch: 01.10.2025',
        'hero-title-line1': 'Platform for',
        'hero-title-line2': 'created by',
        'hero-title-sport1': 'athletes',
        'hero-title-sport2': 'athletes',
        'hero-text': '🤝 Creating training processes, tracking analytics and team synchronization. All in one place. B2B platform for training management.',
        'hero-button': 'Create beta-account',
        'scroll-hint': 'Scroll',
        
        // Statistics
        'stats-title': 'About us in numbers',
        'stats-uptime': 'Always connected and without failures, always reliable.',
        'stats-users': 'Active users in the system.',
        ...
        'benefit-access-title': 'Flexible Access Settings',
        'benefit-access-desc': 'Configure access rights for assistants, athletes or second coaches in 2 clicks.',
        'benefit-crossplatform-title': 'Cross-platform Availability',
        'benefit-crossplatform-desc': 'Start on computer, continue on phone — everything syncs instantly.',
        'benefit-unified-title': 'Unified Training Space',
        'benefit-unified-desc': 'All tools in one place: from planning to video analysis.',
        'benefit-automation-title': 'Complete Process Automation',
        'benefit-automation-desc': 'The system automatically calculates loads, reminds about training and generates reports.',
        'benefit-integration-title': 'Integration with External Services',
        'benefit-integration-desc': 'Connect Garmin Connect, Slack and other platforms for complete automation.',
        'benefit-analytics-title': 'Detailed Analytics and Reports',
        'benefit-analytics-desc': 'Progress in clear graphs, load statistics and detailed training reports.',
        
        // Network section
        'network-center': 'you',
        'network-garmin-title': 'Garmin Connect',
        'network-garmin-desc': 'Connect your account and track activity',
        'network-slack-title': 'Slack Notifications',
        'network-slack-desc': 'Receive notifications in your Slack workspace',
        'network-privacy-title': 'Personal Privacy',
        'network-privacy-desc': 'Manage security and access to your account',
        ...
        'network-export-desc': 'Transfer created workouts to your preferred format',
        'network-other-title': 'Other Features',
        'network-other-desc': 'Create your personal website and page on tsygram',
        
        // Products
        'products-title': 'Our products',
        'tsygram-title': 'Tsygram',
        'tsygram-desc': 'Messenger for teams and athletes',
        'create-website-title': 'Website creation',
        'create-website-desc': 'Create websites for your projects',
        ...
        'pricing-plans-title': 'Tariff Plans',
        'pricing-plans-subtitle': 'Choose the appropriate tariff for yourself or your team.',
        'pricing-basic-title': 'Basic Tariff',
        'pricing-basic-price': '₽0',
        'pricing-basic-subtitle': 'For personal use',
        'pricing-basic-feature1': 'Unlimited room and workout creation',
        'pricing-basic-feature2': 'Allowed storage size: 1 GB',
        'pricing-basic-feature3': 'Change history, deleted data: 30 days',
        'pricing-basic-feature4': 'Support: 9.00 - 18.00',
        'pricing-basic-button': 'Start',
        'pricing-premium-title': 'Premium Tariff',
        'pricing-premium-price': 'from ₽199',
        'pricing-premium-period': '/ month',
        'pricing-premium-subtitle': 'For small teams',
        'pricing-premium-feature1': 'Unlimited room and workout creation',
        'pricing-premium-feature2': 'Allowed storage size: 3 GB',
        'pricing-premium-feature3': 'Change history, deleted data: 90 days',
        'pricing-premium-feature4': 'Support: 24/7',
        'pricing-premium-button': 'Try for free',
        'pricing-comparison-title': 'Tariff Comparison',
        'pricing-comparison-basic': 'Basic',
        'pricing-comparison-premium': 'Premium',
        'pricing-comparison-premium-plus': 'Premium+',
        'pricing-feature-rooms': 'Room and workout creation',
        'pricing-feature-offline': 'Offline mode',
        'pricing-feature-dashboard': 'Progress dashboard',
        'pricing-feature-users': 'Adding users',
        'pricing-feature-roles': 'Role-based access',
        'pricing-feature-export': 'Data export',
        'pricing-feature-storage': 'Allowed storage size',
        'pricing-feature-history': 'Change history, deleted data',
        ...
        'footer-help': 'Help Center',
         ...
         'language-suggestion-text': 'Измените язык',
         
         // AI page
         'ai-page-title': 'T‑Sync | AI Assistant',
         'ai-header-subtitle': 'How can I help you today?',
         'ai-suggest-nav': 'Show site navigation',
         'ai-suggest-products': 'Tell me about products',
         'ai-input-placeholder': 'Type your question here...'
    }
};
...
const translations = {
    RU: {
        ...
        'help-center-title': 'Справочный центр',
        'help-center-subtitle': 'Начните с основ или изучите расширенные функции, чтобы стать экспертом T-Sync.',
        'help-popular-topics': 'Популярные темы',
        'help-card-getting-started-title': 'Начало работы',
        'help-card-getting-started-desc': 'Создайте аккаунт, настройте профиль и изучите основы платформы',
        'help-card-rooms-title': 'Комнаты и тренировки',
        'help-card-rooms-desc': 'Создавайте тренировки, управляйте командами и отслеживайте прогресс',
    ...
    EN: {
        ...
        'help-center-title': 'Help Center',
        'help-center-subtitle': 'Start with the basics or explore advanced features to become a T‑Sync expert.',
        'help-popular-topics': 'Popular topics',
        'help-card-getting-started-title': 'Getting started',
        'help-card-getting-started-desc': 'Create an account, set up your profile, and learn platform basics',
        'help-card-rooms-title': 'Rooms and workouts',
        'help-card-rooms-desc': 'Create workouts, manage teams, and track progress',
